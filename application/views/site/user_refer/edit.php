...
<div class="box-center"><!-- The box-center product-->
             <div><h2>Chỉnh sửa thông tin người giới thiệu</h2>
		      </div>
		      <div class="box-content-center product"><!-- The box-content-center -->
		            <form class="t-form form_action" method="post" action="<?php echo site_url('user_refer/edit')?>" enctype="multipart/form-data">
                          <div class="form-row">
