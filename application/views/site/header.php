...
<div class="top">
      <!-- The top -->
      <div id="xlogo"><!-- the logo --><br>
           <a title="Cổng thông tin thanh toán" href="<?php echo base_url()?>">
             <span style="font-size: 30px; font-weight: bold; color: green; padding-top: 5px">Cổng thông tin thanh toán</span>
	      </a>
       </div>
       <!-- End logo -->
     </div>
    ...
    <div class="clear"></div><!-- clear float -->
           ...
           <ul class="menu_top">
                ...
                <li class=""><a href="<?php echo site_url('user/register')?>">Đăng ký</a></li>
                      -->
                <li class=""><a href="<?php echo site_url('user/login')?>">Đăng nhập của Khách hàng</a></li>

                <?php endif;?>

                <?php if(isset($user_refer_info)):?>
                <li class=""><a href="<?php echo site_url('user_refer')?>">Xin chào: <?php echo $user_refer_info->name?></a></li>
                <li class=""><a href="<?php echo site_url('user_refer/logout')?>">Thoát</a></li>
                <?php else:?>
                      <!--
                <li class=""><a href="<?php echo site_url('user_refer/register')?>">Đăng ký (người giới thiệu)</a></li>
                      -->
                <li class=""><a href="<?php echo site_url('user_refer/login')?>">Đăng nhập của Người giới thiệu</a></li>
