...
<?php $this->load->view('admin/donhang/_common'); ?>
		...
		<fieldset>
			<div class="widget">
				...
				<div class="formRow-One_Three">
					<label class="formLeft" for="param_cap_bac"><?php echo 'Cấp bậc'//lang('dathang_user_name'); ?>:<span class="req">*</span></label>
					<div class="formRight">
						<span class="oneTwox">
							<select name="cap_bac" id="param_cap_bac" _autocheck="true">
								<option value="tongdaily">Tổng đại lý</option>
								<option value="daily">Đại lý</option>
								<option value="chinhanh">Chi nhánh</option>
							</select>
						</span>
						<span name="cap_bac_autocheck" class="autocheck"></span>
						<div name="cap_bac_error" class="clear error"><?php echo form_error('cap_bac')?></div>
					</div>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
				...
				<div class="formRow-One_Three">
					<label class="formLeft" for="param_password"><?php echo lang('dathang_ngay') . ' - định dạng (yyyy-mm-dd)'; ?>:<span class="req">*</span></label>
					<div class="formRight">
				...
				<div class="input_fields_wrap">
					<div>
						<div class="formRow-One_Four">
							...
							<div class="formRight">
								<span class="oneTwox"><input name="product_name[]" class="class_param_product_name" id="param_product_name" _autocheck="true" type="text" /></span>
				...
				<div class="formRow">
           		...
           		<div class="formSubmit">
           			<input type="submit" name="donhang_add" value="<?php echo lang('button_add'); ?>" class="redB" />
