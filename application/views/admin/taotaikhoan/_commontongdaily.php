...
<div class="titleArea">
	<div class="wrapper">
		<div class="pageTitle">
			<h5><?php echo 'Tổng đại lý';//$this->lang->line('mod_user'); ?></h5>
			<span><?php echo '';//$this->lang->line('user_info'); ?></span>
		</div>
		
		<div class="horControlB menu_action">
			<ul>
				<li><a href="<?php echo admin_url('taotaikhoan/taotongdaily'); ?>">
					<img src="<?php echo public_url('admin'); ?>/images/icons/control/16/add.png" />
					<span><?php echo $this->lang->line('add'); ?></span>
				</a></li>
				
				<li><a href="<?php echo admin_url('taotaikhoan/indextongdaily'); ?>">
