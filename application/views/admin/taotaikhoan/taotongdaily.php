...
<?php $this->load->view('admin/taotaikhoan/_commontongdaily'); ?>
		...
		<fieldset>
			<div class="widget">
				<div class="title">
					...
					<h6><?php echo lang('add'); ?> <?php echo 'Tổng đại lý';//echo lang('mod_user'); ?></h6>
				</div>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input name="username" id="param_username" _autocheck="true" type="text" /></span>
				...
				<div class="formRow">
					<label class="formLeft" for="param_dob"><?php echo lang('dob') . ' - LƯU Ý: nhập theo yyyy-mm-dd'; ?>:</label>
					<div class="formRight">
				...
				<div class="formRow">
					<label class="formLeft" for="param_address"><?php echo lang('address') . ' HKTT'; ?>:</label>
					<div class="formRight">
