...
<div class="wrapper">
	<div class="widget">
		...
		<div class="title">
			...
			<h6><?php echo lang('list'); ?> <?php echo 'Tổng đại lý';//lang('mod_user'); ?></h6>
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
			<thead>
				<tr>
					...
					<td><?php echo 'Tên đăng nhập'//lang('email'); ?></td>
			...
			<tbody>
				...
				<?php foreach ($list as $row): ?>
					<tr class="row_<?php echo $row->id?>">
						...
						<td><span title="<?php $row->username//echo $row->email; ?>" class="tipS">
