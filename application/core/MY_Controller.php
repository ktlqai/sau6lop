            ...
            default:
                {
                    ...
                    //kiem tra xem nguoi gioi thieu da dang nhap hay chua
                    $user_refer_id_login = $this->session->userdata('user_refer_id_login');
                    $this->data['user_refer_id_login'] = $user_refer_id_login;
                    //neu da dang nhap thi lay thong tin cua thanh vien
                    if($user_refer_id_login)
                    {
                        $this->load->model('user_refer_model');
                        $user_refer_info = $this->user_refer_model->get_info($user_refer_id_login);
                        $this->data['user_refer_info'] = $user_refer_info;
                    }
